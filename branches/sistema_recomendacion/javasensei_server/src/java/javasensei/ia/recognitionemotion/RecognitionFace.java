...
//  static  double ojoIzq_p1_p2 = 0;
    ...
    public RecognitionResult processFace() throws Exception {
        ...
        String file1 = helper.getFile("javasensei/files/haarcascade_frontalface_alt2.xml"); // Deteccion de Rostros
        String file2 = helper.getFile("javasensei/files/haarcascade_mcs_lefteye.xml"); // Deteteccion de Ojo derecho
        String file3 = helper.getFile("javasensei/files/haarcascade_mcs_mouth.xml"); // Deteteccion de boca
        String file4 = helper.getFile("javasensei/files/haarcascade_mcs_righteye.xml"); //para detectar ojo izquierdo        
